...
@RestController
@CrossOrigin(origins = { "http://localhost:4201", "http://ec2-18-225-36-88.us-east-2.compute.amazonaws.com:8081" }, allowCredentials = "true") // Whenever our browser makes a request
